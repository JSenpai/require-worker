...
const createProcess = (options={ forkOptions:{} })=>{
	...
	// Following line exists due to address already in use error. create a github issue if you need to have child process inspection, so we can figure out a way to do it
