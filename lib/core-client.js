			...
			if(this.rwProcess){
				...
				for(var i=0,l=removedObjects.length; i<l; i++){
					...
					if(hasChilds.indexOf(obj.child)===-1){
						if(requireWorkerObj.coreProcessManager.processMap.has(obj.child)) requireWorkerObj.coreProcessManager.processMap.delete(obj.child);
